...
class SimulatedPointCloud_train(Dataset):
    ...
    def __getitem__(self, index):
        #print(index)
        start = index 
        pcd = self.point_clouds[index:index+128,:,:]  # <128xLx2>
        valid_points = self.valid_points[index:index+128,:]
        ...
        return pcd,valid_points,self.indeces[index:index+128] 

    def __len__(self):
        return 128 #len(self.point_clouds)
